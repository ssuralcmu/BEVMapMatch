...
class ResNetBackbone(nn.Module):
    """Frozen ResNet backbone returning spatial features (B, C, H, W)."""
...
class GridClassifier(nn.Module):
    def __init__(self):
        ...
        self.feature_extractor = ResNetBackbone(arch="resnet50")
...
def main():
    ...
    parser.add_argument('--version', type=str, default="9_resnet50_extraloss_wt0point1")

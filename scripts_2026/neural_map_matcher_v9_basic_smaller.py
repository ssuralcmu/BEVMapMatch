...
class GridClassifier(nn.Module):
    def __init__(self):
        ...
        self.q_proj = nn.Linear(512, 128)
        self.kv_proj = nn.Linear(512, 128)
    ...
    def forward(self, stitched, basemap):
        ...
        stitched_tok = self.q_proj(stitched_tok)                              # (B,25,128)
        ...
        key_value = self.kv_proj(key_value)                                   # (B,100,128)
...
def main():
    ...
    parser.add_argument('--version', type=str, default="9_Basic_Smaller_1x1")

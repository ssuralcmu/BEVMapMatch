...
def main():
    ...
    ap.add_argument("--data_dir", type=str, default="../../scripts_2026_fine/viz_dino_best_3x3crop_modelpred_unitr_8frames")
    ap.add_argument("--img0", type=str)
    ap.add_argument("--img1", type=str)
    ap.add_argument("--out_dir", type=str, default="out_matchanything_all_evaluate_modelpred_rerun_unitr_8frames")

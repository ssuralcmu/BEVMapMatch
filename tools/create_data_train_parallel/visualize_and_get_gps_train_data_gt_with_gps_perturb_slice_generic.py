...
def main() -> None:
    ...
    for data in tqdm(dataflow):
        try:
            ...
            save_path = 'all_train_basemaps_segmented_v3_modelpred/'+name+"_base_map_image.png"  # Change this to your desired save location
            metas_save_path = 'all_train_metas_v3_modelpred/'+name+"_metas.npy"  # Change this to your desired save
